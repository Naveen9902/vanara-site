...
export default function JournalPage() {
  const posts = [
    ...
    },
    {
      ...
      excerpt: 'Every Vanara piece leaves the workshop carrying a number, pressed by hand onto the inside label — not printed, not lasered, not generated by a machine that repeats the same motion a thousand times a day.',
      date: 'Jul 28, 2026',
    },
    {
