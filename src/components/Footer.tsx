  ...
  return (
    <footer className="va-footer">
      <div className="va-footer-grid">
        ...
        <div className="va-footer-col">
          <h5>Shop</h5>
          <a onClick={() => router.push('/shop')}>All field records</a>
      ...
      <div className="va-seal-row">
        <div className="va-seal-panel">
          <svg width="200" height="82" viewBox="0 0 220 90" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="66" y="42" fontFamily="Newsreader, serif" fontWeight="500" fontSize="30" letterSpacing="4" fill="#0A1417">VANARA</text>
            <text x="67" y="60" fontFamily="IBM Plex Mono, monospace" fontSize="8.5" letterSpacing="3" fill="#4E6B72">FIELD RECORDS</text>
          </svg>
